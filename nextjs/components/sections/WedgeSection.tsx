          ...
          <div>
            ...
            <AnimateOnScroll variant="fadeUp" delay={0.15}>
              <h2 className="text-[clamp(28px,4vw,56px)] font-black text-white mb-5 leading-[1.1]">
                De regels van outreach{" "}
                <span className="text-amber-400">zijn veranderd.</span>
              </h2>
            </AnimateOnScroll>
            <AnimateOnScroll variant="fadeUp" delay={0.3}>
              <p className="text-[clamp(14px,1.5vw,17px)] text-white/70 max-w-[460px] mb-9 leading-relaxed">
                Wat als je de impact van handwerk kunt combineren met de snelheid van massamailing? Dat is de kern van Elvatix. Jij bepaalt de strategie, het platform doet het zware tilwerk. Ontdek het zelf hieronder.
              </p>
            </AnimateOnScroll>
