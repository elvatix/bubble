      ...
      <div className="section-inner">
        ...
        <div className="flex flex-col gap-3 max-w-[700px] mx-auto">
          {pains.map((pain, i) => (
            ...
            >
              <span className="shrink-0 flex items-center justify-center w-10 h-10 rounded-sm bg-red-50 text-danger-dark">{pain.icon}</span>
              <div>
              ...
              <span className="ml-auto shrink-0 flex text-gray-300"><XCircleIcon /></span>
            </motion.div>
          ))}
        </div>
      </div>
