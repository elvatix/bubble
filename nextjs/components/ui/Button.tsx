...
export default function Button({ children, variant = 'primary', href, className = '', onClick, type = 'button' }: ButtonProps) {
  ...
  const variants: Record<string, string> = {
    primary: 'bg-elvatix text-white hover:bg-elvatix-dark shadow-md hover:shadow-lg',
    outline: 'border-2 border-elvatix text-elvatix bg-transparent hover:bg-elvatix-light',
    white: 'bg-white text-elvatix hover:bg-gray-50 shadow-md',
  };
